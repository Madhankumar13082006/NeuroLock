...
firebase_admin_1.default.initializeApp({
    credential: firebase_admin_1.default.credential.cert(JSON.parse(process.env.FIREBASE_ADMIN_SDK || "{}")),
...
app.post("/api/generate-link", async (req, res) => {
    try {
        ...
        const link = `${process.env.APP_URL || "http://localhost:3000"}/approve?token=${token}`;
